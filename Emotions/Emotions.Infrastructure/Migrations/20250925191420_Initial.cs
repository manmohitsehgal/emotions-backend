...
namespace Emotions.Infrastructure.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "JournalAttachmentTranscripts",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JournalAttachmentTranscripts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    DefaultPrivacy = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: false),
                    DefaultTranscription = table.Column<bool>(type: "boolean", nullable: false),
                    LocalOnlyPinHash = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_JournalPrivacy", x => x.UserId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PresignedUploadLogs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastEntryAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StreakCounters", x => x.UserId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviewBlobKey = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    WaveformJson = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_JournalAttachment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JournalAttachment_JournalEntries_EntryId",
                        column: x => x.EntryId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlanAdherences", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlanAdherences_Plans_PlanId",
                        column: x => x.PlanId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_Rooms_VoiceRoomId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VoiceRoomConnections_Rooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupportSessions_Rooms_VoiceRoomId",
                        column: x => x.VoiceRoomId,
                        principalTable: "Rooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EndMs = table.Column<int>(type: "integer", nullable: false),
                    Text = table.Column<string>(type: "text", nullable: false),
                    TranscriptSegmentId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JournalAttachment_BlobKey",
                table: "JournalAttachment",
                column: "BlobKey",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_JournalAttachment_EntryId",
                table: "JournalAttachment",
                column: "EntryId");

            migrationBuilder.CreateIndex(
                name: "IX_JournalAttachmentTranscripts_AttachmentId",
                table: "JournalAttachmentTranscripts",
                column: "AttachmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlanAdherences_PlanId",
                table: "PlanAdherences",
                column: "PlanId");

            migrationBuilder.CreateIndex(
                name: "IX_PlanAdherences_PlanId_Date",
                table: "PlanAdherences",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Plans_UserId_StartedAt",
                table: "Plans",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlanSteps_PlanId_DayNumber",
                table: "PlanSteps",
                columns: new[] { "PlanId", "DayNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PresignedUploadLogs_BlobKey",
                table: "PresignedUploadLogs",
                column: "BlobKey",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PresignedUploadLogs_EntryId",
                table: "PresignedUploadLogs",
                column: "EntryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rooms_Status_LastActiveAt",
                table: "Rooms",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TranscriptSegments_AttachmentId_Index",
                table: "TranscriptSegments",
                columns: new[] { "AttachmentId", "Index" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TranscriptSummaries_AttachmentId",
                table: "TranscriptSummaries",
                column: "AttachmentId");

            migrationBuilder.CreateIndex(
                name: "IX_TranscriptWords_SegmentId_Index",
                table: "TranscriptWords",
                columns: new[] { "SegmentId", "Index" },
                unique: true);
